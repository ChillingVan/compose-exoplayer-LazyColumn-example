 ...
 */
import com.chillingvan.samples.composevideo.FlavorDimension
import com.chillingvan.samples.composevideo.Flavor
...
android {
    defaultConfig {
        applicationId = "com.chillingvan.samples.composevideo"
        versionCode = 1
