...
fun DefaultTrack(
    ...
    Canvas(
        ...
        // The second progress line. (Example: video buffer progress)
        secondProgress?.let { secProgress ->
            val secondProgressValueEnd = Offset(
                sliderStart.x + (sliderEnd.x - sliderStart.x) * secProgress,
                center.y
            )
